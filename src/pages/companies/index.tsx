...
export function CompanyListPage(props: CompanyListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCompanies({
        relations: ['user', 'digital_marketing.count', 'visual.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('user', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('digital_marketing', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'digital_marketing',
          header: 'Digital Marketing',
          accessorKey: 'digital_marketing',
          cell: ({ row: { original: record } }: any) => record?._count?.digital_marketing,
        }
      : null,
    hasAccess('visual', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'visual',
          header: 'Visual',
          accessorKey: 'visual',
          cell: ({ row: { original: record } }: any) => record?._count?.visual,
        }
      : null,
